...
function ImageFlow() {
    ...
    this.defaults =
	{
	    ...
	    imagesM: 1.2,            /* Multiplicator for all images in percent */
	    ...
	    reflectionP: 1.2,            /* Height of the reflection in percent of the source image */
        ...
        for (var index = 0; index < max; index++) {
            ...
            if (node && node.nodeType == 1 && node.nodeName == 'IMG') {
                ...
                if (thisObject.reflections === true) {
                    ...
                    src = 'reflect' + version  + src + thisObject.reflectionGET;
