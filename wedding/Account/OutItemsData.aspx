<%@ Page Title="Out Items Data" Language="C#" MasterPageFile="~/Account/MasterPage.master" AutoEventWireup="true" CodeFile="OutItemsData.aspx.cs" Inherits="Account_VendorsData" %>
        ...
        <asp:FileUpload ID="FileUpload1" runat="server" />
           ...
           <%-- <div>
             ...
             <asp:GridView ID="grid_Display" runat="server" CssClass="static" AutoGenerateColumns="False"
                ...
                AllowPaging="True" PageSize="135" BackColor="White" BorderColor="#336666" 
                 BorderWidth="3px" CellPadding="4" Width="480px">
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <td>
                                            <asp:Image ID="image_thumb" ImageUrl='<%# "~/" + Eval("Img") %>' Width="80px" Height="130px" runat="server" />
