...
public partial class cropImage : System.Web.UI.Page
{
    ...
    String path = HttpContext.Current.Request.PhysicalApplicationPath + "Articles\\";
    string Thumb;
    string BigImages;
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        if (FileOK)
        {
            try
            {
                string url = path + Session["WorkingImage"];
        ...
        if (FileSaved)
        {
            ...
            imgCrop.ImageUrl = "~/Articles/" + Session["WorkingImage"].ToString();
        }
    }
    protected void btnCrop_Click(object sender, EventArgs e)
    {
        ...
        using (MemoryStream ms = new MemoryStream(CropImage, 0, CropImage.Length))
        {
            ...
            using (SD.Image CroppedImage = SD.Image.FromStream(ms, true))
            {
                ...
                imgCropped.ImageUrl = "~/Articles/crop" + ImageName;
                Thumb = "~/Articles/crop" + ImageName;
