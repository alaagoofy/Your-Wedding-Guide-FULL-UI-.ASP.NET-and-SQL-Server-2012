...
h++) {
            ...
            switch (k) {
                ...
                case "last": while (l = l.nextSibling) {
                        if (l.nodeType === 1) {
                            return !1
                        } 
                    } return !0;
...
window.Modernizr = (function (I, h, G) {
    var H = "2.6.2", t = {}, j = true, g = h.documentElement, r = "modernizr", s = h.createElement(r), u = s.style, o, F = {}.toString, w = " -webkit- -moz- -o- -ms- ".split(" "), v = "Webkit Moz O ms", f = v.split(" "), i = v.toLowerCase().split(" "), E = {}, p = {}, b = {}, d = [], z = d.slice, l, n = function (R, K, P, T) {
        var S, Q, O, M, L = h.createElement("div"), J = h.body, N = J || h.createElement("body");
        if (parseInt(P, 10)) {
            while (P--) {
        ...
        var K = I.matchMedia || I.msMatchMedia;
        if (K) {
            return K(L).matches
        } var J;
        n("@media " + L + " { #" + r + " { position: absolute; } }", function (M) {
            J = (I.getComputedStyle ? getComputedStyle(M, null) : M.currentStyle)["position"] == "absolute"
        });
        return J
    }, a = ({}).hasOwnProperty, m;
    if (!q(a, "undefined") && !q(a.call, "undefined")) {
        m = function (J, K) {
            return a.call(J, K)
        }
    } else {
        m = function (J, K) {
            return ((K in J) && q(J.constructor.prototype[K], "undefined"))
        }
    } if (!Function.prototype.bind) {
        Function.prototype.bind = function c(M) {
            var L = this;
            if (typeof L != "function") {
                throw new TypeError()
            } var J = z.call(arguments, 1), K = function () {
                if (this instanceof K) {
                    var N = function () { };
                    N.prototype = L.prototype;
                    var P = new N();
                    var O = L.apply(P, J.concat(z.call(arguments)));
                    if (Object(O) === O) {
                        return O
                    } return P
                } else {
                    return L.apply(M, J.concat(z.call(arguments)))
                } 
            };
            return K
        }
        ...
        var N = L.charAt(0).toUpperCase() + L.slice(1), M = (L + " " + f.join(N + " ") + N).split(" ");
        if (q(K, "string") || q(K, "undefined")) {
            return C(M, K)
        } else {
            M = (L + " " + (i).join(N + " ") + N).split(" ");
            return A(M, K, J)
        } 
    } E.touch = function () {
        var J;
        if (("ontouchstart" in I) || I.DocumentTouch && h instanceof DocumentTouch) {
            J = true
        } else {
            n(["@media (", w.join("touch-enabled),("), r, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function (K) {
                J = K.offsetTop === 9
            })
        } return J
    };
    ...
    E.rgba = function () {
        ...
        return e(u.backgroundColor, "rgba")
    };
    ...
    (function (aa, M) {
        ...
        var V = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i;
        var Y;
        var N = "_html5shiv";
        var P = 0;
        var O = {};
        ...
        (function () {
            try {
                var ab = M.createElement("a");
                ab.innerHTML = "<xyz></xyz>";
                Y = ("hidden" in ab);
                Z = ab.childNodes.length == 1 || (function () {
                    (M.createElement)("a");
                    var ad = M.createDocumentFragment();
                    return (typeof ad.cloneNode == "undefined" || typeof ad.createDocumentFragment == "undefined" || typeof ad.createElement == "undefined")
                } ())
            } catch (ac) {
                Y = true;
                Z = true
        ...
        function J(ac, ab) {
            var ad = ac.createElement("p"), ae = ac.getElementsByTagName("head")[0] || ac.documentElement;
            ad.innerHTML = "x<style>" + ab + "</style>";
            return ae.insertBefore(ad.lastChild, ae.firstChild)
        } function Q() {
            var ab = S.elements;
            return typeof ab == "string" ? ab.split(" ") : ab
        } function R(ac) {
            var ab = O[ac[N]];
            if (!ab) {
                ab = {};
            ...
            if (!ae) {
                ...
                return ae.createElement(ad)
            } if (!ab) {
                ab = R(ae)
            } var ac;
            if (ab.cache[ad]) {
                ac = ab.cache[ad].cloneNode()
            } else {
                if (V.test(ad)) {
                    ac = (ab.cache[ad] = ab.createElem(ad)).cloneNode()
                } else {
                    ac = ab.createElem(ad)
                } 
            } return ac.canHaveChildren && !U.test(ad) ? ab.frag.appendChild(ac) : ac
        } function K(ag, ac) {
            if (!ag) {
                ag = M
            } if (Z) {
            ...
            var ab = ac.frag.cloneNode(), ae = 0, ad = Q(), af = ad.length;
            for (;
ae < af;
ae++) {
                ab.createElement(ad[ae])
            } return ab
        } function X(ac, ab) {
            if (!ab.cache) {
                ab.cache = {};
                ab.createElem = ac.createElement;
                ab.createFrag = ac.createDocumentFragment;
                ab.frag = ab.createFrag()
            } ac.createElement = function (ad) {
                if (!S.shivMethods) {
                    return ab.createElem(ad)
                } return L(ad, ac, ab)
            };
            ac.createDocumentFragment = Function("h,f", "return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" + Q().join().replace(/\w+/g, function (ad) {
                ab.createElem(ad);
                ab.frag.createElement(ad);
                return 'c("' + ad + '")'
            }) + ");return n}")(S, ab.frag)
        } function W(ac) {
            if (!ac) {
            ...
            if (S.shivCSS && !Y && !ab.hasCSS) {
                ab.hasCSS = !!J(ac, "article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}mark{background:#FF0;color:#000}")
            } if (!Z) {
                X(ac, ab)
            } return ac
        } var S = { elements: T.elements || "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video", shivCSS: (T.shivCSS !== false), supportsUnknownElements: Z, shivMethods: (T.shivMethods !== false), type: "default", shivDocument: W, createElement: L, createDocumentFragment: K };
        aa.html5 = S;
        W(M)
    } (this, h));
    t._version = H;
...
(function (C, E, G) {
    function H(b) {
        ...
        } var q = q || F.errorTimeout, t = E.createElement(b), v = 0, w = 0, x = { t: h, s: g, e: n, a: p, x: q };
    ...
    } var P = E.documentElement, Q = C.setTimeout, R = E.getElementsByTagName("script")[0], S = {}.toString, T = [], U = 0, V = "MozAppearance" in P.style, W = V && !!E.createRange().compareNode, X = W ? P : R.parentNode, P = C.opera && "[object Opera]" == S.call(C.opera), P = !!E.attachEvent && !P, Y = V ? "object" : P ? "script" : "img", Z = P ? "script" : Y, aa = Array.isArray || function (b) {
        return "[object Array]" == S.call(b)
    }, ab = [], ac = {}, ad = { timeout: function (c, d) {
        return d.length && (c.timeout = d[0]), c
    } 
    }, D, F;
    F = function (c) {
        function d(h) {
            var h = h.split("!"), i = ab.length, j = h.pop(), l = h.length, j = { url: j, origUrl: j, prefixes: h }, o, p, q;
            for (p = 0;
p < l;
p++) {
...
p++) {
            ...
            } var q = !!g.test, r = g.load || g.both, s = g.callback || J, t = s, u = g.complete || J, v, w;
...
k++) {
        ...
        var p = E.createElement("script"), q, r, h = h || F.errorTimeout;
        p.src = b;
        for (r in g) {
        ...
        var k = E.createElement("link"), n, f = m ? L : f || J;
