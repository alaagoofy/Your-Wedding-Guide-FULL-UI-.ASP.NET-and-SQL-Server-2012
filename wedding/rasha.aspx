<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rasha.aspx.cs" Inherits="rasha" %>
...
.slider-wrapper {margin:0;width:700px;height:280px;position:relative}

.nivoSlider {position:relative; }
.nivoSlider img {position:absolute;width:700px;height:280px;display:block}
...
<body>
  ...
  <div class="slider-wrapper theme-default">
                       ...
                       <%--  <a href="ShowCategory.aspx?ID=342" target="_blank"><img src="ClientsSlider/images/large/5.jpg" alt="" /></a>--%>
                             <a href="ShowCategory.aspx?ID=372" target="_blank"><img src="ClientsSlider/images/large/6.jpg" alt="" /></a>
                          <a href="ShowCategory.aspx?ID=103" target="_blank"><img src="ClientsSlider/images/large/3.jpg" alt="" /></a>
                             <a href="ShowCategory.aspx?ID=2" target="_blank"><img src="ClientsSlider/images/large/2.jpg" alt="" /></a>
                             <a href="ShowCategory.aspx?ID=20" target="_blank"><img src="ClientsSlider/images/large/1.jpg" alt="" /></a>
                             <a href="ShowCategory.aspx?ID=83" target="_blank"><img src="ClientsSlider/images/large/4.jpg" alt="" /></a>
